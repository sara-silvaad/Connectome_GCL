...
from configs.config_GCN import (
    model_mapping,
    FC_PATHS,
    ROOT_PATH,
    MATRIX_FILE,
...
general_path = check_path(general_path, config_path="configs/config_GCN.py")
...
for run in range(RUNS):
    ...
    model = model_class(
        hidden_dims=HIDDEN_DIMS, num_classes=dataset.num_classes, model_name=MODEL
    )
